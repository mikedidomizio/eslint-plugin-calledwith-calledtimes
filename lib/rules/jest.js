...
const message =
	`Adding \`.toHaveBeenCalledTimes()\` after \`toHaveBeenCalledWith()\` ensures that a function` +
	` is called with a specific set of arguments, and a specific amount of times.` +
	` This ensures that a function is called no more or no less than what is expected.`;
